...
export default function Header() {
  ...
  return (
    <>
      ...
      <div
        className="navigation-container hidden md:block"
      >
      ...
      <div
        ...
        } md:hidden absolute top-0 right-0 h-screen w-full bg-gold z-50 transition-transform ease-in-out duration-300 transform justify-between flex flex-col`}
      >
        <button
          className={`cross-button md:hidden absolute top-8 right-5 ${
